                ...
                try:
                    ...
                    if "*" in tokens:
                        ...
                        if vartype in ["int", "float", "double"]:
                            ...
                            del tokens[idx + 5]  # remove type
                            del tokens[idx + 3]  # remove colon
                            del tokens[idx + 4]
...
def main():
    try:
        if len(sys.argv) < 2:
            print("[Error] Usage: cpc <filename.cplus> [options]")
            sys.exit(1)
        ...
        if os.path.splitext(filename)[1] != ".cplus":
            print("[Error] A .cplus file is required")
            sys.exit(1)
